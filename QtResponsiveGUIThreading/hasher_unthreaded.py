...
class MainWindow(qtw.QMainWindow):
    ...
    def start_hashing(self):
        """Calculate hashes for the entered directory and add them to the table"""
        ...
        qtc.QTimer.singleShot(500, self.hash_processing_loop)

    def hash_processing_loop(self):
        # Iterate the generator and add hashes to the table
        for name, sha1_sum in self.hash_gen:
