...
class MainWindow(qtw.QMainWindow):
    ...
    def __init__(self):
        ...
        edit_toolbar.addAction(qtg.QIcon(qtg.QPixmap(':/images/paste.svg')), 'paste', self.textedit.paste)
        edit_toolbar.addAction(qtg.QIcon.fromTheme('edit-undo', undo_icon), 'undo', self.textedit.undo)
        edit_toolbar.addAction(qtg.QIcon(qtg.QPixmap(':/images/redo.svg')), 'redo', self.textedit.redo)
